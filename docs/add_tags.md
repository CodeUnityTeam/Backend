...
* Создаются ответы с данными из answers.json на вопрсосы.
* Делаются отклики на созданные проекты, приглашаются пользователи на созданные проекты (отклик от автора)
* Ставяться лайки на проекты, вопросы.

> **Важно:** Повторый запуск скрипта создаёт новые объекты при отсутствии валидации данных в проектах, вопросах, ответах.